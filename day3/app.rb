...
station1.show_trains 					#Выводим все поезда
...
puts "\nудалим ЧЕТВЕРТУЮ станцию, которая является последней"

route1.remove_station(station4)                   #удалим ЧЕТВЕРТУЮ станцию
...
train2.get_carriage
train2.add_carriage               #добавили вагонб вывелиб удалили вагонб вывели
train2.get_carriage
...
train3.go_next(route2) 				#Проиехали одну станцию  еще раз вывели инфу
train3.station_info(route2)

puts "\nПроехали станцию назад и вывели инфу о ближ станциях "


train3.go_back(route2)                 #Проехали станцию назад и вывели инфу
train3.station_info(route2)
